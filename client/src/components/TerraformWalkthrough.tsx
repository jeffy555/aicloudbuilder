...
const slides: Slide[] = [
  {
    ...
    subtitle: "Choose GitHub or Azure DevOps as your repository provider",
    icon: GitBranch,
    content: <SlideProviderSelection />,
  },
  {
    step: 2,
    title: "Repository & Cloud",
    subtitle: "Select repository and cloud provider (Azure / AWS / GCP)",
    icon: Cloud,
  ...
  },
  {
    step: 3,
    title: "Child Module",
    subtitle: "Approach 1: Create a reusable child module — no backend needed",
    icon: Box,
  ...
  },
  {
    ...
    subtitle: "Approach 2: Configure backend and generate standalone root module",
    icon: Layers,
  ...
  },
  {
    ...
    subtitle: "Approach 3: Compose child modules with resource validation",
    icon: Network,
  ...
  },
  {
    step: 6,
    title: "Review & Edit",
    subtitle: "Review generated .tf files in the code editor and make changes",
    icon: FileCode,
  ...
  },
  {
    step: 7,
    title: "Security Scan",
    subtitle: "Checkov scans for misconfigurations with auto-fix for failed checks",
    icon: Shield,
  ...
  },
  {
    step: 8,
    title: "Cost Analysis",
    subtitle: "Analyze monthly/yearly costs per resource with usage profiles",
    icon: Cloud,
  ...
  },
  {
    step: 9,
    title: "Best Approach",
    subtitle: "Validate Terraform best practices and auto-fix errors and warnings",
    icon: Layers,
  ...
  },
  {
    ...
    subtitle: "Generate Mermaid diagrams showing resource relationships",
    icon: Network,
    content: <SlideDraw />,
  },
  {
    step: 11,
    title: "Commit & Push",
    subtitle: "Commit your Terraform configuration to the repository",
    icon: Package,
    content: <SlideCommit />,
  },
];
