  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Phase 1.1: Primary Color Variants
      ...
      // Phase 1.2: Typography - Line Heights
      lineHeight: {
      ...
      // Phase 1.2: Typography - Letter Spacing
      letterSpacing: {
      ...
      // Phase 1.3: Enhanced Spacing Scale
      spacing: {
        // Keep existing Tailwind spacing, add component-specific if needed
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      // Phase 1.4: Enhanced Box Shadows
      boxShadow: {
